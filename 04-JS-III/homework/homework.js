...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  var iguales=0;
  var primer_elemento=arreglo[0];

  for (var i=0;i<arreglo.length;i++)
  {
   if (primer_elemento===arreglo[i])
   {
    iguales++;
   }
  }
...
var meses_ok=[];
 ...
 for (var i=0;i<array.length;i++)
 {
  if ((array[i]==='Enero')||(array[i]==='Marzo')||(array[i]==='Noviembre'))
   {
     meses_resultado.push(array[i]);
     
     if (meses_ok.includes(array[i])===false)
     {
      meses_ok.push(array[i]);
     }
   }
...
//mesesDelAño(['Enero','Marzo','Noviembre','Febrero','Abril'])
...
function mayorACien(array) {
 ...
 //mayorACien([1,2,3,4,5,101,120,125,8])
